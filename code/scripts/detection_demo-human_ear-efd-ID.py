...
def main():
    ...
    PATH_TO_MODEL_DIR = Path("training-ear-recognition/exported_models/ear_recognition_efficientdet_d1")
    PATH_TO_LABELS = Path("training-ear-recognition/annotations/label_map.pbtxt")
    MIN_CONF_THRESH = float(0.01)
    DIR_IMAGES_TEST = Path("test/images")
    DIR_IMAGES_OUT = Path("test/output/output-efd-th-1")
