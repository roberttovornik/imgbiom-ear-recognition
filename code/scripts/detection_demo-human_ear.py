...
def main():
    ...
    PATH_TO_MODEL_DIR = Path("training-detect-same/exported_models/ear_detect_same_ssd_mobilenet_v2_fpnlite")
    PATH_TO_LABELS = Path("training-detect-same/annotations/label_map.pbtxt")
    MIN_CONF_THRESH = float(0.01)
    DIR_IMAGES_TEST = Path("test/images")
    DIR_IMAGES_OUT = Path("test/output/output-th-1")
